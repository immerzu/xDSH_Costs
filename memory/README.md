...
|---|---|---|
| [`HANDOVER_20260910.md`](HANDOVER_20260910.md) | Auftrag, Entscheidungen, Bau, Verifikation, Umgebungs-Lehren, Blocker, offene Punkte der Session vom 10.09.2026. | 2026-09-10 |
...
- Installiert im Automatisierungsprofil (`reasonix-profil`); **im Alltagsbrowser des Nutzers
  noch offen** — dort liegt der Platform-Login.
