// ==UserScript==
// @name         xDeepSeek Billing Badge (DSH)
...
(function () {
    ...
    const log = (...a) => { if (CFG.DEBUG) console.log('[BillingBadge]', ...a); };
    ...
    // =====================================================================
    const BADGE_ID = 'xdsb-billing-badge';
    let badgeEl = null;
    ...
    try {
        ...
        console.error('[BillingBadge] Startfehler', e);
    }
})();
